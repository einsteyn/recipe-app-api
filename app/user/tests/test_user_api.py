...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'abc@abc.com', 'password': 'pw', 'name': 'Test'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not created if incalid credentials are given"""
        create_user(email='abc@abc.com', password='testpass', name='Test')
        payload = {'email': 'abc@abc.com',
                   'password': 'wrongpass', 'name': 'Test'}
        res = self.client.post(TOKEN_URL, payload)
